...
<body>
    ...
    <div class="container">
        ...
        <div class="row row row-cols-6">
            <div class="col-4">
                <img src="../imagenes/principal/bañoEstetica.png" class="d-block w-100 img-prod">
                <br>
                <p><b>BAÑOS Y ESTETICA</b></p>
            ...
            <div class="col-4">
                <img src="../imagenes/principal/clinicaVeterinaria.png" class="d-block w-100 img-prod">
                <br>
                <p><b>CLINICA VETERINARIA</b></p>
            ...
            <div class="col-4">
                <img src="../imagenes/principal/hospedaje.png" class="d-block w-100 img-prod">
                <br>
                <p><b>HOSPEDAJE DE MASCOTA</b></p>
        ...
        <div class="row row row-cols-6">
            <div class="col-4">
                <img src="../imagenes/principal/viajesMascota.png" class="d-block w-100 img-prod">
                <br>
                <p><b>TRAMITE DE VIAJES PARA MASCOTAS</b></p>
            ...
            <div class="col-4">
                <img src="../imagenes/principal/cremacion.png" class="d-block w-100 img-prod">
                <br>
                <p><b>CREMACION DE MASCOTAS</b></p>
                <P>Presencia virtual.<br>Servicio sin presencia.<br>Ventas de urnas.<br>Certificado de cremacion.<br>Servicio de recojo y entrega a domicilio.</P>
            </div>
            <div class="col-4">
                <img src="../imagenes/principal/comidas.png" class="d-block w-100 img-prod">
                <br>
                <p><b>COMIDAS PREMIUN</b></p>
                <P>Pro Plan, BRIT, Nutram, Hills, Virbac,<br>Nutranuggets, Vet Life, Taste of the<br>Wild, etc.</P>
