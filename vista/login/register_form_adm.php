...
<div class="sticky-top">
        <nav class="navbar navbar-expand-lg bg-danger navbar-dark border-5 border-bottom border-primary">
            <div class="container-fluid">
                ...
                <ul class="navbar-nav ms-3">
                    <li class="nav-item">
                        <a class="nav-link text-nowrap" href="#"><i class="fa-solid fa-cart-shopping fa-2xl"></i></a>
                    </li>
                </ul>   
            </div>
        </nav>
...
<div class="contenedor">
    <div class="form-container">
        <h3 class="titulo-Formulario">Crear Cuenta Administrador</h3>
        <?php
            if(isset($error)){
        ...
        <form action="" method="post" class="formulario" id="formulario">
            <!-- Grupo: id clinica -->
			 <div class="formulario__grupo 1" id="grupo__id_clinica">
				 <label for="id_clinica" class="label_select">Id Clinica</label>
				 <div class="formulario__grupo-input">
					 <input type="text" class="formulario__input" name="id_clinica" id="id_clinica" value="1" readonly>
				 </div>  
			 </div>
            ...
            <!-- Grupo: Tipo de usuario -->
             ...
             <!-- Grupo: Genero -->
			 <div class="formulario__grupo 5" id="grupo__genero_adm">
				 <label for="genero_adm" class="label_select">Genero</label>
				 <div class="formulario__grupo-input">
                    <select name="genero_adm" class="formulario__input" name="genero_adm" id="genero_adm">
			 ...
			 <!-- Grupo: dni-admin -->
			 <div class="formulario__grupo 2" id="grupo__dni_adm">
				 
				 <div class="formulario__grupo-input">
					 <input type="text" class="formulario__input" name="dni_adm" id="dni_adm" placeholder=" " value="<?php if(isset($dni_adm)) echo $dni_adm?>">
                     <label for="dni_adm" class="formulario__label">DNI</label>
					 <i class="formulario__validacion-estado fas fa-times-circle"></i>
				 </div>
				 <p class="formulario__input-error">El Dni tiene que ser de 7 a 9 dígitos.</p>
			 </div>
			 <!-- Grupo: Nombre -->
			 <div class="formulario__grupo 3" id="grupo__nombre_adm">
				 <div class="formulario__grupo-input">
					 <input type="text" class="formulario__input" name="nombre_adm" id="nombre_adm" placeholder=" " value="<?php if(isset($nombre_adm)) echo $nombre_adm?>">
                     <label for="nombre_adm" class="formulario__label">Nombre</label>
					 <i class="formulario__validacion-estado fas fa-times-circle"></i>
				 </div>
			 ...
			 <!-- Grupo: Apellido -->
			 <div class="formulario__grupo 4" id="grupo__apellido_adm">
				 <div class="formulario__grupo-input">
					 <input type="text" class="formulario__input" name="apellido_adm" id="apellido_adm" placeholder=" " value="<?php if(isset($apellido_adm)) echo $apellido_adm?>">
                     <label for="apellido_adm" class="formulario__label">Apellido</label>
					 <i class="formulario__validacion-estado fas fa-times-circle"></i>
				 </div>
			 ...
			 <!-- Grupo: Direccion -->
			 <div class="formulario__grupo 6" id="grupo__direccion_adm">
				 <div class="formulario__grupo-input">
					 <input type="text" class="formulario__input" name="direccion_adm" id="direccion_adm" placeholder=" " value="<?php if(isset($direccion_adm)) echo $direccion_adm?>">
                     <label for="direccion_adm" class="formulario__label">Direccion</label>
					 <i class="formulario__validacion-estado fas fa-times-circle"></i>
				 </div>
				 <p class="formulario__input-error">La direccion es incorrecta</p>
			 </div>
			 <!-- Grupo: Teléfono -->
			 <div class="formulario__grupo 7" id="grupo__telefono_adm">
				 <div class="formulario__grupo-input">
					 <input type="text" class="formulario__input" name="telefono_adm" id="telefono_adm" placeholder=" " value="<?php if(isset($telefono_adm)) echo $telefono_adm?>">
                     <label for="telefono_adm" class="formulario__label">Teléfono</label>
					 <i class="formulario__validacion-estado fas fa-times-circle"></i>
				 </div>
			 ...
			 <div class="formulario__grupo 9" id="grupo__password">
				 ...
				 <p class="formulario__input-error">La contraseña tiene que ser de 3 a 15 dígitos.</p>
			 </div>
			 <!-- Grupo: Contraseña 2 -->
        ...
        <div class="tienes-cuenta">
            <p>Ya tienes una cuenta? <a href="../adm/dashboard/dashboard.php">Regresar</a></p>
        </div>
    </div>
</div>
<!-- --------------------------------------------------------------------------------------------------- -->
...
<script src="../js/validar_formulario_registrar_adm.js"></script>
</body>
</html>
</body>
</html>